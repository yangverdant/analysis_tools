"""
Import Copa America complete data
- Match data from 2001-2024
"""
...
CSV_PATH = 'd:/football_tools/data/04_international/copa_america/copa_america_all.csv'

# Team name mappings for South American national teams
TEAM_MAP = {
    'Brazil': 'Brazil',
    'Brasil': 'Brazil',
    'Argentina': 'Argentina',
...
def import_copa_america():
    print('=' * 60)
    print('Importing Copa America Data')
    print('=' * 60)
    ...
    for idx, row in df.iterrows():
        try:
            ...
            if existing:
                ...
                match_id = f'copa_america_{year}_{date}_{home_team_id}_vs_{away_team_id}'
                cursor.execute('''
                    INSERT INTO matches (
                ...
                ''', (match_id, league_id, year, date, time_str,
                      home_team_id, away_team_id, home_goals, away_goals,
                      home_shots, away_shots, home_shots_target, away_shots_target))
                inserted += 1
