"""
Generate standings for Eredivisie from match data
"""
import sqlite3
import os
...
def generate_standings():
    ...
    # Delete existing Eredivisie standings
    ...
    # Verify
    cursor.execute('SELECT COUNT(*) FROM standings WHERE league_id = ?', (league_id,))
    count = cursor.fetchone()[0]
    print(f'Total Eredivisie standings: {count}')
    ...
    cursor.execute('''
        ...
        WHERE s.league_id = ? AND s.position <= 3
