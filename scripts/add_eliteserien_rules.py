"""
Add Eliteserien league rules to database
"""
import sqlite3
...
def add_eliteserien_rules():
    ...
    # Eliteserien rules data (2012-2026)
    # Norwegian league runs March-November
    ...
    # 14th place plays relegation playoff
    # Bottom team directly relegated
    ...
    conn.commit()
    print(f'Inserted {inserted} league rules for Eliteserien')
