...
def collect_uefa_players():
    """采集欧冠主要球队的球员数据"""
    print("=" * 60)
    print("Collecting UEFA Competition Players...")
    print("=" * 60)
    ...
    teams = fetch_api("get_teams", {"league_id": ucl_api_id})
    ...
    print(f"  Got {len(teams)} teams from Champions League")
    ...
    conn.close()
    print(f"\nTotal players collected: {total_players}")
    return total_players


if __name__ == "__main__":
    collect_uefa_players()
    print("\nDone!")