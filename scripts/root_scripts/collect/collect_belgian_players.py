...
if __name__ == "__main__":
    print("=" * 60)
    print("Belgian Player Data Collection")
    print("=" * 60)

    collect_players(JUPILER_API_ID, "Jupiler Pro League")
    collect_players(CHALLENGER_API_ID, "Challenger Pro League")
